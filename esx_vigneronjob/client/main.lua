...
function OpenVehicleSpawnerMenu()
	...
	if Config.EnableSocietyOwnedVehicles then
		...
		local elements = {
			{label = 'Veiculo de Trabalho',  value = 'bison3'},
		}
...
function blips()
	if publicBlip == false then
		...
		AddTextComponentString("Herdade da Bombeira")
